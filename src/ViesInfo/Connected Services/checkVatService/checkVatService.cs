...
namespace ViesInfo.checkVatService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="ViesInfo.checkVatService.checkVatPortType")]
    internal interface checkVatPortType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ViesInfo.checkVatService.checkVatResponse checkVat(ViesInfo.checkVatService.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ViesInfo.checkVatService.checkVatResponse> checkVatAsync(ViesInfo.checkVatService.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ViesInfo.checkVatService.checkVatApproxResponse checkVatApprox(ViesInfo.checkVatService.checkVatApproxRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ViesInfo.checkVatService.checkVatApproxResponse> checkVatApproxAsync(ViesInfo.checkVatService.checkVatApproxRequest request);
    }
    ...
    internal partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    ViesInfo.checkVatService.matchCode traderNameMatch, 
                    ViesInfo.checkVatService.matchCode traderCompanyTypeMatch, 
                    ViesInfo.checkVatService.matchCode traderStreetMatch, 
                    ViesInfo.checkVatService.matchCode traderPostcodeMatch, 
                    ViesInfo.checkVatService.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    internal interface checkVatPortTypeChannel : ViesInfo.checkVatService.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    internal partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<ViesInfo.checkVatService.checkVatPortType>, ViesInfo.checkVatService.checkVatPortType
    {
        ...
        ViesInfo.checkVatService.checkVatResponse ViesInfo.checkVatService.checkVatPortType.checkVat(ViesInfo.checkVatService.checkVatRequest request)
        {
        ...
        {
            ViesInfo.checkVatService.checkVatRequest inValue = new ViesInfo.checkVatService.checkVatRequest();
            inValue.countryCode = countryCode;
            inValue.vatNumber = vatNumber;
            ViesInfo.checkVatService.checkVatResponse retVal = ((ViesInfo.checkVatService.checkVatPortType)(this)).checkVat(inValue);
        ...
        public System.Threading.Tasks.Task<ViesInfo.checkVatService.checkVatResponse> checkVatAsync(ViesInfo.checkVatService.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ViesInfo.checkVatService.checkVatApproxResponse ViesInfo.checkVatService.checkVatPortType.checkVatApprox(ViesInfo.checkVatService.checkVatApproxRequest request)
        {
        ...
        public System.DateTime checkVatApprox(
                    ...
                    out ViesInfo.checkVatService.matchCode traderNameMatch, 
                    out ViesInfo.checkVatService.matchCode traderCompanyTypeMatch, 
                    out ViesInfo.checkVatService.matchCode traderStreetMatch, 
                    out ViesInfo.checkVatService.matchCode traderPostcodeMatch, 
                    out ViesInfo.checkVatService.matchCode traderCityMatch, 
                    out string requestIdentifier)
        {
            ViesInfo.checkVatService.checkVatApproxRequest inValue = new ViesInfo.checkVatService.checkVatApproxRequest();
            inValue.countryCode = countryCode;
            inValue.vatNumber = vatNumber;
            ...
            ViesInfo.checkVatService.checkVatApproxResponse retVal = ((ViesInfo.checkVatService.checkVatPortType)(this)).checkVatApprox(inValue);
            countryCode = retVal.countryCode;
            vatNumber = retVal.vatNumber;
            valid = retVal.valid;
        ...
        public System.Threading.Tasks.Task<ViesInfo.checkVatService.checkVatApproxResponse> checkVatApproxAsync(ViesInfo.checkVatService.checkVatApproxRequest request)
        {
